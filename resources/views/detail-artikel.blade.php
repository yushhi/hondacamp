    ...
    <link rel="alternate" type="application/rss+xml" title="Beehive Preview &raquo; Using Social Network Properly for Businesses Comments Feed" href="feed/index.html" />
    ...
    <link rel='prev' title='Few Challenges Farmers Face In Agriculture' href='https://mythemestore.com/beehive-preview/challenges-farmers-face-in-agriculture/' />
    ...
    <meta name="msapplication-TileImage" content="https://mythemestore.com/beehive-preview/wp-content/uploads/2020/01/cropped-site-icon-270x270.png" />
        ...
        <body class="bp-nouveau post-template-default single single-post postid-259 single-format-standard theme-beehive woocommerce-no-js beehive beehive-guest-user beehive-child elementor-default elementor-kit-588 title-bar-active full-width no-js">
    ...
    <article id="post-259" class="post-259 post type-post status-publish format-standard has-post-thumbnail hentry category-technology tag-marketing beehive-post">
        <div class="entry-header">
                    ...
                    <!-- <span class="author-link">By: <a href="https://mythemestore.com/beehive-preview/author/razor/" title="Posts by Sephiroth" rel="author">Sephiroth</a></span> -->
                </div>
                    <div class="entry-title">
                                <h1 class="title h1">{{ $artikel->judul }}</h1>					</div>
        </div>
                <div class="entry-meta"><span class="link date-links"><i class="uil-calender"></i><a href="#">{{ Carbon\Carbon::parse($artikel->created_at)->format('d M Y') }}</a></span></div>
                        <div class="entry-thumbnail">
                    
        <div class="post-medias">
                        <div class="item-media">
                                        <span style="background-image: url('{{ url('/images/'.$artikel->file) }}');"></span>
    ...
    <footer id="footer" class="site-footer default-footer">
                ...
                <div class="container">
                    <div class="copyright-text">
                        <p>
                                                        Muslim Go Online © 2021. All rights reserved											</p>
                    </div>
                </div>
            </div>
        </footer>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="https://mythemestore.com/beehive-preview/wp-login.php" method="post" id="modal-login-form" class="beehive-login-form modal-login-form" name="modal-login-form">
                        ...
                        <input type="hidden" id="modal-login-security" name="modal-login-security" value="d1ceb2a102" /><input type="hidden" name="_wp_http_referer" value="/beehive-preview/effective-use-of-social-network-for-businesses/" />											<div class="register-link">
    ...
    var rtMedia_update_plupload_comment = {"url":"\/beehive-preview\/effective-use-of-social-network-for-businesses\/upload\/","runtimes":"html5,flash,html4","browse_button":"rtmedia-comment-media-upload","container":"rtmedia-comment-media-upload-container","filters":[{"title":"Media Files","extensions":"jpg,jpeg,png,gif,mp4,mov,m4v,m2v,avi,mpg,flv,wmv,mkv,webm,ogv,mxf,asf,vob,mts,qt,mpeg,x-msvideo,3gp,mp3,wma,ogg,wav,m4a"}],"max_file_size":"256M","multipart":"1","urlstream_upload":"1","flash_swf_url":"https:\/\/mythemestore.com\/beehive-preview\/wp-includes\/js\/plupload\/plupload.flash.swf","silverlight_xap_url":"https:\/\/mythemestore.com\/beehive-preview\/wp-includes\/js\/plupload\/plupload.silverlight.xap","file_data_name":"rtmedia_file","multi_selection":"","multipart_params":{"redirect":"no","redirection":"false","action":"wp_handle_upload","_wp_http_referer":"\/beehive-preview\/effective-use-of-social-network-for-businesses\/","mode":"file_upload","rtmedia_upload_nonce":"c95fde7aac"},"max_file_size_msg":"256M"};
    ...
    <script type='text/javascript' src='../wp-includes/js/comment-reply.min03e2.js?ver=5.4.6'></script>
    <script type='text/javascript'>
    /* <![CDATA[ */
    ...
    <!-- Mirrored from mythemestore.com/beehive-preview/effective-use-of-social-network-for-businesses/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 04:10:32 GMT -->
    </html>
