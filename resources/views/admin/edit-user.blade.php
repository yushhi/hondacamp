                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <div style="background-color: #cdcdcd" class="form-control">{{ $user->name }}</div>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <div style="background-color: #cdcdcd" class="form-control">{{ $user->email }}</div>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <div style="background-color: #cdcdcd" class="form-control">{{ $user->nomer_wa }}</div>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <div style="background-color: #cdcdcd" class="form-control">{{ $user->category_id }}</div>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <div style="background-color: #cdcdcd" class="form-control">{{ $user->subcategory_id }}</div>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <div style="background-color: #cdcdcd" class="form-control">{{ $user->nomer_angka }}</div>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <div style="background-color: #cdcdcd" class="form-control">{{ $user->nomer_mesin }}</div>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <div style="background-color: #cdcdcd" class="form-control">{{ $user->alamat }}</div>
                      </div>
                    </div>
