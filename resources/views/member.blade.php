...
<nav class="activity-type-navs main-navs bp-navs dir-navs " role="navigation" aria-label="Directory menu">
        ...
        @php $users = DB::table('users')->orderBy('created_at', 'desc')->take(6)->get(); @endphp

        <div id="members-dir-list" class="members dir-list" data-bp-list="members" style="display: block; padding-top: 30px">
            <ul id="members-list" class="item-list members-list bp-list grid two">
                @foreach($users as $user)
                <li class="item-entry animate-item slideInUp odd is-online is-current-user" data-bp-item-id="3" data-bp-item-component="members" style="visibility: visible; animation-name: slideInUp;">
                    <div class="list-wrap" style="min-height: 200px">
                        <div class="item-avatar">
                            <div>
                                <img loading="lazy" src="/images/{{$user->avatar}}" class="avatar user-3-avatar avatar-200 photo" width="200" height="200" alt="">
                            </div>
                        </div>
                        <div class="item">
                            <div class="item-block">
                                ...
                                <div class="text-muted"><small>Bergabung {{ Carbon\Carbon::parse($user->created_at)->format('d M Y') }}</small></div>
                                <p class="item-meta last-activity mute">{{$user->provinsi}} - {{$user->kabupaten}}</p>
