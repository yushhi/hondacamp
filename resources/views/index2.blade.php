    ...
    <head>
        ...
        <link rel="alternate" type="application/rss+xml" title="Honda Camp" href="feed/index.html" />
        ...
        <div class="inner-panel ass-scrollbar">
            <div class="panel-block dark">
                <a href="https://mythemestore.com/beehive-preview/" class="panel-logo item">
                    <img src="/images/logohondacamp.jpg"  style="border-radius: 50%; background-color: white; padding: 2px"/>
                    <h3 style="font-family: Roboto ,Arial,sans-serif; color: white; padding-top: 12px">Honda Camp</h3>
                </a>
    ...
    <!-- Content Header (Page header) -->
                    ...
                    <div id="groups-dir-list" class="groups dir-list" data-bp-list="groups" style="display: block;">
                      ...
                      @foreach($groups as $post)
                        <li class="item-entry animate-item slideInUp odd public is-member group-has-avatar" data-bp-item-id="4" data-bp-item-component="groups" style="visibility: visible; animation-name: slideInUp;">
                        
                          <div class="list-wrap">
                            <div class="item-cover" style="background-image: url('https://mythemestore.com/beehive-preview/wp-content/uploads/buddypress/groups/4/cover-image/5e2cc36891950-bp-cover-image.jpg')">
                            </div>
                            <div class="item-avatar">
                              <a href="/group/{{ $post->id }}">
                                <img loading="lazy" src="/images/logohondacamp.jpg" class="avatar group-4-avatar avatar-200 photo" width="200" height="200" style="background-color: white" >
                              </a>
                            </div>
                            <div class="item">
                              <div class="item-block">
                                <h5 class="list-title groups-title">
                                  <a href="/group/{{ $post->id }}" class="bp-group-home-link backpakers-club-home-link">{{ $post->title }}</a>
                                  <span class="last-activity item-meta mute" style="font-size: 14px; font-family: Nunito Sans, Arial, sans-serif; font-weight: 400">{{ $post->body }}</span>
                                  <ul class=" groups-meta action">
                                    <li id="groupbutton-4" >
                                      <a href="/group/{{ $post->id }}">
                                        <button class="group-button leave-group button" style="font-size: 14px; font-family: Nunito Sans, Arial, sans-serif"  >Lihat Group</button>
                                      </a>
                                    </li>
                                  </ul>
                                </h5>
    ...
    @php $users = DB::table('users')->orderBy('created_at', 'desc')->take(5)->get(); @endphp
                ...
                <ul id="members-list" class="item-list" aria-live="polite" aria-relevant="all" aria-atomic="true">
                        ...
                        <li class="vcard">
                            <div class="item-avatar">
                                <a href="#" class="bp-tooltip" data-bp-tooltip="{{ $user->name }}"><img loading="lazy" src="/images/{{$user->avatar}}" class="avatar user-3-avatar avatar-50 photo" width="50" height="50" alt="Profile picture of John Doe" /></a>
                            </div>
    
                            <div class="item">
                                <div class="item-title fn"><a href="#">{{ $user->name }}</a></div>
                                <div class="item-meta">
