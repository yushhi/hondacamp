...
<!-- Mirrored from mythemestore.com/beehive-preview/members/user/profile/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 06:37:11 GMT -->
...
<head>
	...
	<link rel="alternate" type="application/rss+xml" title="Beehive Preview | John Doe | Activity RSS Feed" href="https://mythemestore.com/beehive-preview/members/user/activity/feed/" />
...
<style id='bp-nouveau-inline-css' type='text/css'>
		...
		#buddypress #header-cover-image {
			height: 280px;
			background-image: url( ../../../wp-content/uploads/buddypress/members/3/cover-image/612556df158fa-bp-cover-image.jpg);
		}
...
<meta name="msapplication-TileImage" content="https://mythemestore.com/beehive-preview/wp-content/uploads/2020/01/cropped-site-icon-270x270.png" />
	...
	<body class="xprofile bp-user my-profile profile public buddypress bp-nouveau bbp-user-page single singular bbpress page-template-default page page-id-0 page-parent theme-beehive woocommerce-no-js beehive beehive-guest-user beehive-child elementor-default elementor-kit-588 title-bar-active beehive-social-layout panel-collapsed no-sidebar no-js">
...
<div id="beehive-social-panel" class="beehive-social-panel">
	<div class="inner-panel ass-scrollbar">
		<div class="panel-block dark">
			<a href="#" class="item">
				<img src="/images/logohondacamp.jpg" alt="Beehive Preview" style="border-radius: 50%; background-color: white; padding: 6px; width: 120px"/>
			</a>
		...
		<div class="panel-block light">
			<div class="panel-menu item">
                <ul id="menu-dashboard-menu" class="navbar-panel">
                    <li id="menu-item-74" style="padding-bottom: 12px" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-74">
                    ...
                    <li id="menu-item-74" style="padding-bottom: 12px" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-370 current_page_item menu-item-74">
                        <a href="https://mythemestore.com/beehive-preview/activity/">
...
<div class="beehive-title-bar social">
	<div class="title-bar-wrapper">
					<div class="title-wrapper screen-reader-text">
									<h1 class="title h3">John Doe</h1>
							</div>
					</div>
</div>


<article id="post-0" class="bp_members type-bp_members post-0 page type-page status-publish hentry beehive-post">
...
<div id="cover-image-container">
	<div id="header-cover-image" style=" text-align: center; background-image: url('/images/cover1.png');"></div>
		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div id="item-header-avatar">
					<div class="item-avatar">
						<a href="">
							<img loading="lazy" src="/images/{{Auth::user()->avatar}}" class="avatar user-3-avatar avatar-200 photo" width="200" height="200" alt="Profile picture of John Doe" />						</a>
											</div>
			...
			<div class="col-lg-9">
				<div id="item-header-content">
							...
							<span class="activity">Active 5 minutes ago</span>
						</div><!-- #item-meta -->
...
<nav class="main-navs no-ajax bp-navs single-screen-navs horizontal users-nav" id="object-nav" role="navigation" aria-label="Member menu">
	...
	<div class="row">
		<div class="col-lg-6 ml-auto mr-auto">
			<div class="nav-container" style="padding-bottom: 50px">
...
<nav class="bp-navs bp-subnavs no-ajax user-subnav" id="subnav" role="navigation" aria-label="Profile menu">
	<ul class="subnav">
		...
		<li id="public-personal-li" class="bp-personal-sub-tab"  data-bp-user-scope="public">
			<a href="profile" id="public">View</a>
		</li>
        <li id="edit-personal-li" class="bp-personal-sub-tab" data-bp-user-scope="edit">
            <a href="edit-profile" id="edit">Edit Profile</a>
        </li>
        <li id="edit-personal-li" class="bp-personal-sub-tab" data-bp-user-scope="edit">
            <a href="edit-password" id="edit">Edit Password</a>
        </li>
        <li id="edit-personal-li" class="bp-personal-sub-tab  current selected" data-bp-user-scope="edit">
            <a href="edit-foto-profile" id="edit">Ganti Foto Profile</a>
        </li>
    ...
    <div class="profile change-avatar">
            ...
            <div class="bp-avatar">
                <div class="bp-uploader-window">
                    <div id="bp-upload-ui" class="drag-drop" style="position: relative;">
                        <div id="drag-drop-area" style="position: relative;" class>
                            <div class="drag-drop-inside" style="text-align: center;">
                                <img src="/images/{{Auth::user()->avatar}}" style="height: 140px; background-color: rgb(233, 236, 239);">
                            
                                <p class="drag-drop-buttons">
                                    <p style="color: rgb(166, 168, 170); font: bold 8pt Arial;">140x140</p>
                                    <label for="bp-browse-button" class="bp-screen-reader-text">Select your file</label>
                                    <input type="file" id="bp-browse-button" value="Select your file" class="button" style="position: relative; z-index: 1;">
                                
                                    <div class="submit" style="padding-top:16px">
                                        <input type="submit" name="profile-group-edit-submit" id="profile-group-edit-submit" value="Simpan Perubahan">
                                    </div>
                                </p>
                            </div>
                        </div>

                        <div id="html5_1fe053d9lso8vo11f7q1birnps5_container" class="moxie-shim moxie-shim-html5" style="position: absolute; top: 71px; left: 185px; width: 166px; height: 40px; overflow: hidden; z-index: 0;">
                            <input id="html5_1fe053d9lso8vo11f7q1birnps5" type="file" style="font-size: 999px; opacity: 0; position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;" accept>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bp-avatar-status">
            <p class="warning" style="background-color: #ffd; border: 1px solid #cb2; color: #440; display: block; font-size: 90%; margin: 1em 0; padding: 10px 15px">
...
<!-- .profile -->
                    ...
                    <div id="bp_core_members_widget-2" class="widget widget_bp_core_members_widget buddypress widget"><h5 class="widget-title">Member DPS</h5>
@php $users = DB::table('users')->orderBy('created_at', 'desc')->get(); @endphp
            <div class="item-options" id="members-list-options">
                <a href="https://mythemestore.com/beehive-preview/members/" id="newest-members" >Newest</a>
                <span class="bp-separator" role="separator">|</span>
                <a href="https://mythemestore.com/beehive-preview/members/" id="recently-active-members" class="selected">Active</a>
...
<li id="menu-item-112" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-112"><a href="#">Contact</a></li>
</ul></nav>
                    </aside>
				</div>
...
@endif
	...
	<script type='text/javascript' src='../../../wp-content/plugins/bbpress/templates/default/js/editor.mind7ad.js?ver=2.6.6'></script>
...
<script type='text/javascript'>
/* <![CDATA[ */
var BP_Nouveau = {"ajaxurl":"https:\/\/mythemestore.com\/beehive-preview\/wp-admin\/admin-ajax.php","confirm":"Are you sure?","show_x_comments":"Show all %d comments","unsaved_changes":"Your profile has unsaved changes. If you leave the page, the changes will be lost.","object_nav_parent":"#buddypress","objects":["activity","members","groups","xprofile","friends","messages","settings","notifications","group_members","group_requests"],"nonces":{"activity":"6ab2876330","members":"b42e4af8eb","groups":"80edf168dd","xprofile":"66d0351f54","friends":"1f2154ebca","messages":"3a3d441367","settings":"e13fc23ca5","notifications":"5e0afeb9d4"}};
/* ]]> */
</script>
...
<!-- Mirrored from mythemestore.com/beehive-preview/members/user/profile/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 06:37:46 GMT -->
</html>
