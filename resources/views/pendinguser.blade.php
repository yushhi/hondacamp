<!DOCTYPE html>
	...
	<meta name="msapplication-TileImage" content="https://mythemestore.com/beehive-preview/wp-content/uploads/2020/01/cropped-site-icon-270x270.png" />
		...
		<body class="bp-nouveau blog theme-beehive woocommerce-no-js hfeed beehive beehive-guest-user beehive-child elementor-default elementor-kit-588 title-bar-active right-sidebar no-js">
	...
	<div class="beehive-title-bar default">
		<div class="title-bar-wrapper">
				...
				<div class="container">
					<div role="navigation" aria-label="Breadcrumbs" class="beehive-breadcrumb breadcrumbs"><ul class="trail-items" ><li itemprop="itemListElement" class="trail-item trail-begin"><a href="/" rel="home" itemprop="item"><span itemprop="name">Home</span></a><meta itemprop="position" content="1"></li><li class="trail-item trail-end"><span>Artikel</span></li></ul></div>			</div>
			</div>
			</div>
	</div>
	...
	<div id="primary" class="content-area">
		...
		<div class="beehive-post-container blog-layout-grid masonry grid-columns-2">
			...
			<article id="post-259" class="post-259 post type-post status-publish format-standard has-post-thumbnail hentry category-technology tag-marketing beehive-post" style="position: absolute; left: 0px; top: 0px;">
				<div class="entry-wrapper">
					<div class="entry-thumbnail">
						<div class="post-medias">
							<div class="item-media">
								<a href="/artikel/{{ $artikel->id }}" style="background-image: url('{{ url('/images/'.$artikel->file) }}');">
								</a>
							</div>
						</div>
					</div>
					<div class="entry-content">
						<div class="entry-meta">
							<span class="link date-links">
								<a href="/artikel/{{ $artikel->id }}">{{ Carbon\Carbon::parse($artikel->created_at)->format('d M Y') }}</a>
							</span>
						</div>
						...
						<div class="entry-excerpt">
							<p>{{ str_limit($artikel->keterangan, 180, '.....') }}</p>
						</div>
						<div class="read-more">
							<a href="/artikel/{{ $artikel->id }}" class="color-primary">Lanjutkan membaca...</a>
						</div>
					</div>
				</div>
			</article>
	...
	<div class="col-lg-4 col-aside"><aside id="default_sidebar" class="widget-area sidebar-widget-area sticky-sidebar">	
			...
			<h5 class="widget-title">Artikel Terbaru</h5>
				<ul>
					...
					<li><i class="far fa-file-alt"></i>
						<a href="/artikel/{{ $artikel->id }}">{{ $artikel->judul }}</a></li>
					@endforeach
						</ul>
			</div>
			<div id="meta-3" class="widget widget_meta"><h5 class="widget-title">Meta</h5>			<ul>
							<li><a href="https://mythemestore.com/beehive-preview/wp-login.php">Log in</a></li>
				<li><a href="https://mythemestore.com/beehive-preview/feed/">Entries feed</a></li>
				<li><a href="https://mythemestore.com/beehive-preview/comments/feed/">Comments feed</a></li>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="https://mythemestore.com/beehive-preview/wp-login.php" method="post" id="modal-login-form" class="beehive-login-form modal-login-form" name="modal-login-form">
						...
						<input type="hidden" id="modal-login-security" name="modal-login-security" value="0bb035e369" /><input type="hidden" name="_wp_http_referer" value="/beehive-preview/blog/" />											<div class="register-link">
	...
	<!-- Mirrored from mythemestore.com/beehive-preview/blog/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Aug 2021 09:21:42 GMT -->
	</html>
